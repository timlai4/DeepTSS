...
with CustomObjectScope({'metrics': metrics}):
    model1.load_weights('DNN_balance.h5')
    model2.load_weights('DNN_unbalance.h5')
...
with open('balanced_performance','wb') as f:
    pickle.dump(balance_perf,f)
with open('unbalanced_performance','wb') as f:
    pickle.dump(unbalance_perf,f)
with open('balance_pred','wb') as f:
    pickle.dump(balance_pred,f)
with open('unbalance_pred','wb') as f:
